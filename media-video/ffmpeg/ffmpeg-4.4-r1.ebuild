...
FFMPEG_ENCODER_FLAG_MAP=(
	...
	openh264:libopenh264 rav1e:librav1e svt-vp9:libsvtvp9 svt-av1:libsvtav1 svt-hevc:libsvthevc snappy:libsnappy theora:libtheora twolame:libtwolame
...
RDEPEND="
	...
	encode? (
		...
		svt-hevc? ( >=media-libs/svt-hevc-1.5.0 )
...
PATCHES=(
	...
	"${FILESDIR}"/n4.4-0001-lavc-svt_hevc-add-libsvt-hevc-encoder-wrapper.patch
